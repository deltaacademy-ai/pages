    ...
    <div className="min-h-screen" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <header style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="mx-auto flex max-w-6xl items-center gap-3 px-6 py-4">
          <img src="https://tutoriais.deltaacademy.ai/ai-talks/logo.png" alt="AI Talks" className="h-8 w-auto rounded" />
          <span className="text-sm font-bold tracking-widest uppercase" style={{ color: 'rgba(255,255,255,0.7)' }}>Delta Academy</span>
        </div>
      </header>
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-6 pb-16 pt-12 lg:grid-cols-[1.1fr_1fr] lg:pb-24 lg:pt-20">
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            ...
            Material exclusivo da palestra
          </span>
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed" style={{ color: 'rgba(255,255,255,0.6)' }}>
            Acesse os materiais exclusivos da palestra AI Talks e leve para o seu negócio os frameworks, cases e roteiros usados por empresas AI-First.
          </p>
